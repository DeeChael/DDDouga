package net.deechael.dddouga.configuration.file;

import net.deechael.dddouga.configuration.Configuration;
import net.deechael.dddouga.configuration.ConfigurationSection;
import net.deechael.dddouga.configuration.InvalidConfigurationException;
import net.deechael.dddouga.configuration.serialization.ConfigurationSerialization;
...
public class YamlConfiguration extends FileConfiguration {
    ...
    public YamlConfiguration() {
        ...
        yaml = new DDYaml(constructor, representer, yamlDumperOptions, yamlLoaderOptions);
    }
